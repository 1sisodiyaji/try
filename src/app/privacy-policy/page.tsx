...
const privacyPolicyContentData = [
  ...
  //   },
  {
    ...
    description: `Craft Foss Labs has the discretion to update this privacy policy
  ...
  return (
    <div className='max-w-4xl mx-auto my-10 px-6'>
      <p className='tracking-wider'>
        ...
        craftfosslabs.com collects, uses, maintains and discloses
        information collected from users (each, a “User”) of the{" "}
        <Link
          href='https://craftfosslabs.com/'
          className='shover:text-blue-400'
        >
          https://craftfosslabs.com/
        </Link>{" "}
        website (“Site”). This privacy policy applies to the Site and all
        products and services offered by Craft Foss Labs GitHub.
      </p>

      {privacyPolicyContentData.map(({ title, description }, index) => {
        return (
          <div key={index}>
            <h3 className='mt-10 mb-2 font-semibold text-lg tracking-wider'>
              {title}
            </h3>
            <p className='tracking-wider'>
              {description}
